    ...
    axios.post('https://api.weekday.technology/adhoc/getSampleJdJSON')
      .then(response => {
        ...
        let filteredJobs = response.data.jdList.filter(job => {
          ...
          if (filters.minExperience && (job.minExp < filters.minExperience || job.maxExp < filters.minExperience)) {
            return false;
          }
          ...
          if (filters.techStack && !job.jobDetailsFromCompany.toLowerCase().includes(filters.techStack.toLowerCase())) {
            return false;
          }
          // Filter by role
          ...
          if (filters.minBasePay && job.minJdSalary && job.minJdSalary < filters.minBasePay) {
            return false;
          }
